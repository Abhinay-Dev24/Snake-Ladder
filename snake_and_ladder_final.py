...
dices=[]
for x in range(1, 7):
    img = pygame.image.load("dice.png")
...
def show_winner(winner):
    font = pygame.font.Font("Game_Of_Squids.txt ", 32)
...
def go_ladder_snake(pos=0):
    SNAKES_LADDERS={1:38, 4: 14, 9: 31, 21: 42, 28: 84, 51: 67, 72:91, 80:99, 17:7, 54:34, 64:60, 87:36, 93:73, 94:75, 98:79}
    if pos in SNAKES_LADDERS.keys():
        return SNAKES_LADDERS[pos]
    else:
        return pos
                ...
                if events.key == pygame.K_SPACE:
                    ...
                    if player==1:
                        if 100-player_1_pos>6:
                            ...
                            player_1_pos = go_ladder_snake(player_1_pos)
                            update_pos(player_1_pos, player_2_pos)
                        ...
                        if 100-player_2_pos>6:
                            ...
                            player_2_pos = go_ladder_snake(player_2_pos)
                            update_pos(player_1_pos, player_2_pos)
